...
public class AdapterForMatchInfo extends ArrayAdapter<String> {
    ...
    public AdapterForMatchInfo(Context context, String[] matchNo, String[] date, String[] venue, String[] team1, String[] team2, int[] flag_team1, int[] flag_team2) {
        super(context, R.layout.custom_row_qualifying_group, matchNo);
        this.c = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_row_qualifying_group, null);
        }
